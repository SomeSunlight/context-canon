...
> - `## Changes` removes, overrides, or activates authorized exceptions from imported sources using stable published IDs.
> - `## Topics` points to deeper information. Topic references may be required or optional.
> - `Why:` is optional but recommended whenever the reason is not obvious.
> - `<!-- ctx:... -->` comments contain compiler-managed IDs/package metadata. Do not edit them manually.
>
