...
`main` is the last project-owner-reviewed, fully reproducible ContextCanon stage. Work on one coherent block per branch/PR and use two distinct gates:
